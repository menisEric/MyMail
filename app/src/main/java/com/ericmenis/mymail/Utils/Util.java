package com.ericmenis.mymail.Utils;
...
public class Util {
    ...
    public static List<Mail> getDummyData() {
        return new ArrayList<Mail>() {{
            add(new Mail("Presupuesto 2020", "Hola Eric, este es el presupuesto para el año 2020 del que mencionaste en la reunión de ayer. Está en formato PDF, ya me dices que te parece. Un Saludo", "antonio@gmail.com"));
            ...
            add(new Mail("Partida Tenis", "ey Eric, ¿Cuándo dijiste que íbamos a ir a jugar ese torneo de tenis? Deberíamos entrenar antes del primero partido, ya me dices.", "maria@gmail.com"));
            ...
            add(new Mail("Cursos 2019", "Cuñado, he visto unos cursos muy interesantes sobre programación. Pásate por mi casa hoy y le echamos un vistazo!", "rafael@gmail.com"));
